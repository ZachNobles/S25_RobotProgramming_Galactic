...
class TurtleClient(Node):
    def __init__(self):
        ...
        ####adding setPen -Jesse
        self.declare_parameter('penSize', 3.0 , ParameterDescriptor(description='Pen size'))
...
def main(args=None):
    ...
    while rclpy.ok():
        ...
        #### publish twist ####
       #The Below is commented out to remove publishing velocity.
     #   cmd_msg = Twist()
