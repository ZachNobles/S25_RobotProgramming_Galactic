...
# Changed by Jasmine King on 2/23/25
# Added parameter to set the initial color of the turtle and the pen size of the turtle
        self.declare_parameter('turtleColor', 'red', ParameterDescriptor(description= 'Initial turtle color'))
        self.declare_parameter('penSize', 3.0, ParameterDescriptor(description="Initial turtle pen size"))
        
# Changed by Jasmine King on 2/23/25
# Added turtle color as a string and pen size as a double then displayed both of them
...
# Changed by Jasmine King on 2/23/25
# Added create service client for set color
